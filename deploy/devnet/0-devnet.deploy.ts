...
async function main(): Promise<void> {
  ...
  const CurveStableOracle = await ethers.getContractFactory(CONTRACT_NAMES.CurveStableOracle);
  const stableOracle = <CurveStableOracle>(
    await CurveStableOracle.deploy(coreOracle.address, ADDRESS.CRV_ADDRESS_PROVIDER)
  );
  ...
  const hardVault = <HardVault>await upgrades.deployProxy(HardVault, [config.address]);
  ...
  const usdcSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bUSDC, 'Interest Bearing USDC', 'ibUSDC'])
  );
  ...
  const alcxSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bALCX, 'Interest Bearing ALCX', 'ibALCX'])
  );
  ...
  const ohmSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bOHM, 'Interest Bearing OHM', 'ibOHM'])
  );
  ...
  const crvSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bCRV, 'Interest Bearing CRV', 'ibCRV'])
  );
  ...
  const mimSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bMIM, 'Interest Bearing MIM', 'ibMIM'])
  );
  ...
  const balSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bBAL, 'Interest Bearing BAL', 'ibBAL'])
  );
  ...
  const linkSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bLINK, 'Interest Bearing LINK', 'ibLINK'])
  );
  ...
  const daiSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bDAI, 'Interest Bearing DAI', 'ibDAI'])
  );
  ...
  const ethSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bWETH, 'Interest Bearing ETH', 'ibETH'])
  );
  ...
  const wbtcSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS_DEV.bWBTC, 'Interest Bearing wBTC', 'ibwBTC'])
  );
  ...
  const wgauge = <WCurveGauge>(
    await upgrades.deployProxy(WCurveGauge, [ADDRESS.CRV, ADDRESS.CRV_REGISTRY, ADDRESS.CRV_GAUGE_CONTROLLER])
  );
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    0,
    [ADDRESS.wstETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.ETH, ADDRESS.ICHI_VAULT_ALCX_USDC],
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    1,
    [ADDRESS.wstETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.ETH, ADDRESS.ICHI_VAULT_USDC_ALCX],
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    2,
    [ADDRESS.wstETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.ETH, ADDRESS.ICHI_VAULT_ALCX_ETH],
    [30000, 30000, 30000, 30000, 30000]
  );
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    3,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.ETH, ADDRESS.ICHI_VAULT_ETH_USDC],
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    4,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.ETH, ADDRESS.ICHI_VAULT_USDC_ETH],
    [30000, 30000, 30000, 30000, 30000, 30000]
  );
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    5,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.ETH, ADDRESS.ICHI_VAULT_WBTC_USDC],
    [30000, 30000, 30000, 30000, 30000, 30000]
  );
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    6,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.ETH, ADDRESS.ICHI_VAULT_USDC_WBTC],
    [30000, 30000, 30000, 30000, 30000, 30000]
  );
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    7,
    [ADDRESS.ETH, ADDRESS.OHM, ADDRESS.wstETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.ICHI_VAULT_OHM_ETH],
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    9,
    [ADDRESS.ETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.ICHI_VAULT_WBTC_ETH],
    [30000, 30000, 30000, 30000, 30000, 30000]
  );
  ...
  await ichiSpell.setCollateralsMaxLTVs(
    10,
    [ADDRESS.ETH, ADDRESS.USDC, ADDRESS.DAI, ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.ICHI_VAULT_ETH_WBTC],
    [30000, 30000, 30000, 30000, 30000, 30000]
  );
  ...
  await auraSpell.setCollateralsMaxLTVs(
    0,
    [ADDRESS.WBTC, ADDRESS.ETH, ADDRESS.DAI, ADDRESS.LINK, ADDRESS.BAL, ADDRESS.BAL_AURA_STABLE],
    [70000, 70000, 70000, 70000, 70000, 70000]
  );

  await auraSpell.addStrategy(ADDRESS.BAL_ETH_BASKET, utils.parseUnits('5000', 18), utils.parseUnits('2500000', 18));
  await auraSpell.setCollateralsMaxLTVs(
    1,
  ...
  await auraSpell.setCollateralsMaxLTVs(
    3,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.ETH, ADDRESS.DAI, ADDRESS.LINK, ADDRESS.BAL_AURA_STABLE],
    [70000, 70000, 70000, 70000, 70000, 70000]
  );
  ...
  await convexSpell.addStrategy(ADDRESS.CRV_FRXETH, utils.parseUnits('5000', 18), utils.parseUnits('2500000', 18));
  await convexSpell.setCollateralsMaxLTVs(
    0,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.ETH, ADDRESS.DAI, ADDRESS.LINK, ADDRESS.CRV_FRXETH],
    [200000, 200000, 200000, 200000, 200000, 200000]
  );

  await convexSpell.addStrategy(ADDRESS.CRV_STETH, utils.parseUnits('5000', 18), utils.parseUnits('2500000', 18));
  await convexSpell.setCollateralsMaxLTVs(
    1,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.ETH, ADDRESS.DAI, ADDRESS.LINK, ADDRESS.CRV_STETH],
    [200000, 200000, 200000, 200000, 200000, 200000]
  );

  await convexSpell.addStrategy(ADDRESS.CRV_MIM3CRV, utils.parseUnits('5000', 18), utils.parseUnits('2500000', 18));
  await convexSpell.setCollateralsMaxLTVs(2, [ADDRESS.MIM, ADDRESS.CRV_MIM3CRV], [50000, 50000]);

  await convexSpell.addStrategy(ADDRESS.CRV_CVXCRV_CRV, utils.parseUnits('5000', 18), utils.parseUnits('2500000', 18));
  await convexSpell.setCollateralsMaxLTVs(
    3,
    [ADDRESS.WBTC, ADDRESS.ETH, ADDRESS.DAI, ADDRESS.LINK, ADDRESS.CRV_CVXCRV_CRV],
    [70000, 70000, 70000, 70000, 70000]
  );

  await convexSpell.addStrategy(ADDRESS.CRV_ALCX_FRAXBP, utils.parseUnits('5000', 18), utils.parseUnits('2500000', 18));
  await convexSpell.setCollateralsMaxLTVs(
    4,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.ETH, ADDRESS.DAI, ADDRESS.LINK, ADDRESS.CRV_ALCX_FRAXBP],
    [30000, 30000, 30000, 30000, 30000, 30000]
  );

  await convexSpell.addStrategy(ADDRESS.CRV_OHM_FRAXBP, utils.parseUnits('5000', 18), utils.parseUnits('2500000', 18));
  await convexSpell.setCollateralsMaxLTVs(
    5,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.ETH, ADDRESS.DAI, ADDRESS.LINK, ADDRESS.CRV_OHM_FRAXBP],
    [50000, 50000, 50000, 50000, 50000, 50000]
  );

  await convexSpell.addStrategy(ADDRESS.CRV, utils.parseUnits('5000', 18), utils.parseUnits('2500000', 18));
  await convexSpell.setCollateralsMaxLTVs(
    6,
  ...
  await convexSpell.addStrategy(ADDRESS.CRV_TriCrypto, utils.parseUnits('5000', 18), utils.parseUnits('2500000', 18));
  await convexSpell.setCollateralsMaxLTVs(
    7,
  ...
  await shortLongSpell.addStrategy(daiSoftVault.address, utils.parseUnits('5000', 18), utils.parseUnits('25000', 18));
  ...
  await shortLongSpell.addStrategy(ethSoftVault.address, utils.parseUnits('5000', 18), utils.parseUnits('25000', 18));
  await shortLongSpell.setCollateralsMaxLTVs(
    1,
    [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.ETH, ADDRESS.DAI],
  ...
  await shortLongSpell.addStrategy(ethSoftVault.address, utils.parseUnits('5000', 18), utils.parseUnits('25000', 18));
  await shortLongSpell.setCollateralsMaxLTVs(2, [ADDRESS.WBTC, ADDRESS.wstETH, ADDRESS.DAI], [50000, 50000, 50000]);

  await shortLongSpell.addStrategy(wbtcSoftVault.address, utils.parseUnits('5000', 18), utils.parseUnits('25000', 18));
  await shortLongSpell.setCollateralsMaxLTVs(3, [ADDRESS.wstETH, ADDRESS.ETH, ADDRESS.DAI], [50000, 50000, 50000]);

  await shortLongSpell.addStrategy(daiSoftVault.address, utils.parseUnits('5000', 18), utils.parseUnits('25000', 18));
  await shortLongSpell.setCollateralsMaxLTVs(4, [ADDRESS.WBTC, ADDRESS.DAI, ADDRESS.ETH], [50000, 50000, 50000]);

  await shortLongSpell.addStrategy(linkSoftVault.address, utils.parseUnits('5000', 18), utils.parseUnits('25000', 18));
  await shortLongSpell.setCollateralsMaxLTVs(
    5,
  ...
  await shortLongSpell.addStrategy(daiSoftVault.address, utils.parseUnits('5000', 18), utils.parseUnits('25000', 18));
  await shortLongSpell.setCollateralsMaxLTVs(6, [ADDRESS.WBTC, ADDRESS.DAI, ADDRESS.ETH], [50000, 50000, 50000]);

  await bank.whitelistSpells(
    [auraSpell.address, convexSpell.address, ichiSpell.address, curveSpell.address, shortLongSpell.address],
  ...
  await bank.whitelistERC1155(
    [werc20.address, wichiFarm.address, waura.address, wconvex.address, wgauge.address],
    true
  );

  await bank.addBank(ADDRESS.ALCX, alcxSoftVault.address, hardVault.address, 8500);
  await bank.addBank(ADDRESS.DAI, daiSoftVault.address, hardVault.address, 8500);
  await bank.addBank(ADDRESS.USDC, usdcSoftVault.address, hardVault.address, 8500);
  await bank.addBank(ADDRESS.ETH, ethSoftVault.address, hardVault.address, 8500);
  await bank.addBank(ADDRESS.WBTC, wbtcSoftVault.address, hardVault.address, 8500);
  await bank.addBank(ADDRESS.OHM, ohmSoftVault.address, hardVault.address, 8500);
  await bank.addBank(ADDRESS.LINK, linkSoftVault.address, hardVault.address, 8500);
  await bank.addBank(ADDRESS.CRV, crvSoftVault.address, hardVault.address, 8500);
  await bank.addBank(ADDRESS.MIM, mimSoftVault.address, hardVault.address, 8500);
  await bank.addBank(ADDRESS.BAL, balSoftVault.address, hardVault.address, 8500);
}
