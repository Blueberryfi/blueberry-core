...
async function main(): Promise<void> {
  ...
  const usdcSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bUSDC, 'Interest Bearing USDC', 'ibUSDC'])
  );
  ...
  const alcxSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bALCX, 'Interest Bearing ALCX', 'ibALCX'])
  );
  ...
  const ohmSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bOHM, 'Interest Bearing OHM', 'ibOHM'])
  );
  ...
  const crvSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bCRV, 'Interest Bearing CRV', 'ibCRV'])
  );
  ...
  const mimSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bMIM, 'Interest Bearing MIM', 'ibMIM'])
  );
  ...
  const balSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bBAL, 'Interest Bearing BAL', 'ibBAL'])
  );
  ...
  const linkSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bLINK, 'Interest Bearing LINK', 'ibLINK'])
  );
  ...
  const daiSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bDAI, 'Interest Bearing DAI', 'ibDAI'])
  );
  ...
  const ethSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bWETH, 'Interest Bearing ETH', 'ibETH'])
  );
  ...
  const wbtcSoftVault = <SoftVault>(
    await upgrades.deployProxy(SoftVault, [config.address, ADDRESS.bWBTC, 'Interest Bearing wBTC', 'ibwBTC'])
  );
