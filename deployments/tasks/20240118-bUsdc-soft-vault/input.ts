...
const USDC = new Task('00000000-constants', TaskMode.READ_ONLY);
...
const tokenName = 'Blueberry Wrapped USDC';
const tokenSymbol = 'bUSDC';

const vaultName = 'Interest Bearing USDC';
const vaultSymbol = 'ibUSDC';
