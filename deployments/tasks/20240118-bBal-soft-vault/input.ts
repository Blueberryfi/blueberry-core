...
const BAL = new Task('00000000-constants', TaskMode.READ_ONLY);
...
const tokenName = 'Blueberry Wrapped BAL';
const tokenSymbol = 'bBAL';

const vaultName = 'Interest Bearing BAL';
const vaultSymbol = 'ibBAL';
